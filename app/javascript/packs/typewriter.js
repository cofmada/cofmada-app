document.addEventListener('turbolinks:load', () => {
  ...
  【ユーザー登録】で登録後、ログインしてください。`;
  const txt2 = `放送している媒体のカテゴリを選択し、チャンネル情報を登録できます。`;
  const txt3 = `登録したチャンネルの一覧が確認でき、情報の編集や削除が行えます。`;
  const txt4 = `登録したチャンネル情報を元に番組表の作成・登録ができます。`;
  const txt5 = `作成済みの番組表の一覧が確認でき、表の編集や削除が行えます。`;
